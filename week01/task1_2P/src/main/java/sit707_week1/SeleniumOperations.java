...
public class SeleniumOperations {
	...
	public static void open_chrome_loadpage_resize_close() {
		...
		System.out.println("Hello from <224200457>, <Issac Joly>");
		// Replace above with your actual student ID and name, e.g.:
		// System.out.println("Hello from 12345678, John Doe");
		
		// Step 1: Locate chrome driver folder in the local drive.
		// *** IMPORTANT: Change this path to your own chromedriver location ***
		System.setProperty("webdriver.chrome.driver", "C:\\\\Users\\\\issac\\\\Desktop\\\\softqnt\\\\New folder_2\\\\chromedriver-win64\\\\chromedriver.exe");
